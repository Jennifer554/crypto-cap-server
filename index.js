...
(async () => {
  ...
  await mongoose
    .connect(
      "mongodb+srv://crypticap:olamidefaruk@cluster0.o9cejx9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
      // process.env.localdbURI
    )
    .then(() => {
